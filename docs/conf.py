...
"""
shopify_webhook documentation build configuration file.
...
#
# html_title = 'shopify_webhook v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'shopify_webhook'),
                os.path.join(root_path, 'shopify_webhook/migrations')])
